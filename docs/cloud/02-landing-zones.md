# Landing Zones: The Governed Cloud Foundation

AWS, Azure, and Google Cloud all use the concept of a **landing zone**—sometimes called a foundation or baseline environment. It solves recurring problems that appear when cloud adoption grows beyond a few test accounts or workloads.
