...
Start with the provider-neutral concepts, then follow the implementation guide for your cloud platform.

## Foundations

1. [Why cloud computing became popular](01-cloud-computing.md)
2. [Landing zones: the governed cloud foundation](02-landing-zones.md)
